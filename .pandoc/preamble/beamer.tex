...
\pgfdeclareimage{beamerTitleLogoYale}{$HOME/.pandoc/preamble/images/yaleLogo}
\titlegraphic{
    \begin{tikzpicture}[remember picture,overlay]
        ...
        \node [scale=0.250] (yaleTitleLogo) [left=0.15cm of aliceTitleLogo] {\pgfuseimage{beamerTitleLogoYale}};
    \end{tikzpicture}
}
