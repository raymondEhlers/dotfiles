...
highlight String gui=None guifg=#80a0ff guibg=bg
...
"highlight SpecialChar gui=bold guifg=White guibg=bg
"highlight Tag gui=bold guifg=White guibg=bg
"highlight Delimiter gui=bold guifg=White guibg=bg
"highlight SpecialComment gui=bold guifg=White guibg=bg
"highlight Debug gui=bold guifg=White guibg=bg
