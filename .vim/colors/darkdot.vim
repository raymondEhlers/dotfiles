...
hi Normal	cterm=none			gui=none	guibg=#333333 	guifg=#a8aaaa
...
hi LineNr				ctermfg=gray		guibg=#404040	guifg=#000000
hi CursorLineNr			cterm=none			guibg=#cccccc	guifg=#000000
hi ModeMsg				ctermfg=white				guifg=#ffffff
hi MoreMsg				ctermfg=green				guifg=#44ff44
hi NonText				ctermfg=blue				guifg=#4444ff
hi Pmenu 	ctermbg=gray 		ctermfg=black 				guibg=#aaaaaa  	guifg=#000000 
hi PmenuSel ctermbg=gray 		ctermfg=white 				guibg=#cccccc 	guifg=#ffffff
...
hi Function	ctermfg=green			guifg=#33cc99
